...
## COMPLETED
- Real-time Video Ingestion (RTSP / WebRTC)
- Asynchronous YOLOv8 Object Detection & ByteTrack
- Virtual Tripwire Intrusion Detection (Multi-line support)
...
## IN PROGRESS
- **Night Vision Edge Enhancement:** Applying Histogram Equalization (CLAHE) dynamically on CCTVs with poor lux capability.
- **ALPR Optimization:** Moving EasyOCR processing to asynchronous GPU pools to prevent single-thread blocking.
